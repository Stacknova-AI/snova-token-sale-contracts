...
### NativeCurrencyRetrieved

```solidity
event NativeCurrencyRetrieved(uint256 amount)
```

Emitted when native currency is retrieved from the contract.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| amount | uint256 | The amount of native currency retrieved. |
...
Emitted when ERC20 tokens are retrieved from the contract.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| token | address | The address of the ERC20 token retrieved. |
| amount | uint256 | The amount of tokens retrieved. |
...
```solidity
function retrieveNativeCurrency() external
```

Retrieves native currency sent to the contract.
...
```solidity
function retrieveTokens(address token_, uint256 amount_) external
```

Retrieves ERC20 tokens sent to the contract.
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| token_ | address | The address of the ERC20 token to retrieve. |
| amount_ | uint256 | The amount of tokens to retrieve. Emits a {TokensRetrieved} event on successful retrieval. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | address | address The updated referral address. |
